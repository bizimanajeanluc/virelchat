...
import { User, Shield, Check, X, Search, Mail, Phone, Calendar, ShieldAlert, Trash2, Edit2, Save, UserCheck, UserMinus, MoreVertical, RefreshCw, Radio } from 'lucide-react';
...
export const Admin: React.FC = () => {
  ...
  const handleSendBroadcast = () => {
    ...
    getSocket()?.emit('send_broadcast', { message: broadcastMessage });
    setBroadcastMessage('');
    alert('Broadcast transmitted to all nodes.');
  };
